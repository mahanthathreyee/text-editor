...
use crate::{constants, editor_config, editor_cursor, editor_visual, terminal_utility, utility};
...
pub fn init_editor(editor_config: &mut editor_config::EditorConfig) {
    ...
    update_mode_in_status_line(editor_config, &mut buffer, &EDITOR_MODES::EDIT);
